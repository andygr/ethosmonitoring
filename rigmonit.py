    ...
    if (choice<=8):
       ...
       if choice == 1:
           ...
           with open( 'rig_cond.py', 'r+' ) as f:
                ...
                f.seek(0)
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + str1 + "'" + '\n' )  
                file_data.insert(8, "value = " + "'" + value1 + "'" + '\n' )
           ...
           with open( 'rig_thash.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + flt2 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value2 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + minval1 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       elif choice == 3:
           ...
           with open( 'rig_algpu.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + flt3 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value3 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + minval2 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       elif choice == 4:
           ...
           with open( 'rig_togpu.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + flt4 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value4 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + minval3 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       elif choice == 5:
           ...
           with open( 'rig_alrigs.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + flt5 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value5 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + minval4 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       elif choice == 6:
           ...
           with open( 'rig_torigs.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + flt6 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value6 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + minval5 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       elif choice == 7:
           ...
           with open( 'rig_avgtemp.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + flt7 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value7 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + maxval6 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       elif choice == 8:
           ...
           with open( 'rig_hagpu.py', 'r+' ) as f:
                ...
                file_data.insert(5, "address = " + "'" + address + "'" + '\n' )
                file_data.insert(6, "email = " + "'" + email + "'" + '\n' )
                file_data.insert(7, "string = " + "'" + str8 + "'" + '\n' )
                file_data.insert(8, "value = " + "'" + value8 + "'" + '\n' )
                file_data.insert(9, "minvalue = " + "'" + minval7 + "'" + '\n' )
                file_data = "".join(file_data)
                f.write(file_data)
                f.close()
       break
