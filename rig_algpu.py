...
if minvalue in strfinal1:
    check = 'Yes... PROBLEM'
    os.system('echo "The monitoring system reported a problem with the Total Hash of the rig, check your rig portal"  | mail -v -s "ETHOS Worker 5f8cab Update" WRITE YOUR EMAIL HER')
else:
    check = 'No Problem'    
