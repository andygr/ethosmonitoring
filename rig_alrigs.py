...
if minvalue in strfinal1:
    ...
    os.system('echo "The monitoring system reported a problem with the Total Hash of the rig, check your rig portal"  | mail -v -s "ETHOS Worker 5f8cab Updatee" andre8525@hotmail.com')
    check = 'Yes... PROBLEM'
